...
function Footer() {
    return ( 
    <div className='container-fluid border-top mt-5 footer-container' style={{backgroundColor:"#fbfbfb"}}>
        <div className='row mt-5 '>
            ...
            <div className='col text-muted custom-links'>
            ...
            <div className='col text-muted custom-links' style={{textDecoration:"none"}}>
