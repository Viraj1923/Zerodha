    ...
    return (
        <div className='container'>
            <div className='row p-5'>
                <h1 className='fs-2 text-muted'>To create a ticket, select a relevant topic
                </h1>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4><i class="fa fa-bar-chart" aria-hidden="true"></i> Kite</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4><i class="fa fa-credit-card-alt" aria-hidden="true"></i>  Funds</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4><i class="fa fa-codiepie" aria-hidden="true"></i> Console</h4>
