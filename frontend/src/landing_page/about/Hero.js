        ...
        <div className='container'>
            ...
            <div className='row p-5 mt-5 border-top text-muted ' style={{lineHeight:"1.8",fontSize:"1.2em"}}>
                ...
                <div className='col-6 p-5'>
                    ...
                    <p style={{textDecoration:"none"}}><a href='' >Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
